...
export default class Registion extends Component {
    state = {
        Loading: false,
        error: false,
        Done: false,
                                ...
                                <form>
                                    ...
                                    {this.state.error ? (
                                        <div
                                            ...
                                            role="alert"
                                        >
                                            {translate[this.state.lang].rerr}
                                        </div>
                                    ) : (
                                        <div></div>
                                    )}
                                    <div className="form-group">
                                        ...
                                        >
                                            {translate[this.state.lang].ca}
                                        </button>
                                    </div>
                                    <p className="text-center">
                                        {translate[this.state.lang].ha}{" "}
                                        <a href>
                                            {translate[this.state.lang].li}
                                        </a>
                                    </p>
                                </form>
                            </article>

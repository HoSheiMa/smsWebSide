...
export default class CodePhone extends Component {
    state = {};
    componentWillMount() {
    ...
    render() {
        const classs = this.props.classs
            ? "mb-1 mr-1 col-sm-12 col-md-12 col-lg-2" + this.props.classs
            : "mb-1 mr-1 col-sm-12 col-md-12 col-lg-2";
        return (
            <FormControl className={classs} variant="outlined">
                <InputLabel id="demo-simple-select-label">
                    {translate[this.state.lang].code}
                </InputLabel>
                <Select
                    onChange={d => this.props.setCode(d.target.value)}
                    labelId="demo-simple-select-label"
                    id="demo-simple-select"
                >
                    <MenuItem data-countryCode="GB" value="44" Selected>
                        UK (+44)
                    </MenuItem>
